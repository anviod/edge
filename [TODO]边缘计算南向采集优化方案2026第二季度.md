...
*   **设计文档**: `d:\code\edgex\[TODO]边缘计算南向采集优化方案2026第二季度.md` (本文档)
*   **移植指南**: `d:\code\edgex\docs\TODO\设备画像优化移植指南.md`
*   **接口代码**: `d:\code\edgex\internal\core\device_adapter.go`
*   **参考实现**: 
    - `d:\code\edgex\internal\core\rtt_manager.go`, `d:\code\edgex\internal\core\mtu_manager.go`, `d:\code\edgex\internal\core\gap_optimizer.go`
    - `d:\code\edgex\internal\core\shadow_core.go`, `d:\code\edgex\internal\core\shadow_ingress.go`
    - `d:\code\edgex\internal\core\gossip_sync.go`, `d:\code\edgex\internal\core\bbolt_store.go`
*   **单元测试**: 
    - `d:\code\edgex\internal\core\device_adapter_test.go`
    - `d:\code\edgex\internal\core\shadow_core_test.go`
    - `d:\code\edgex\internal\core\gossip_sync_test.go`
*   **配置示例**: 
    - `d:\code\edgex\config\device_adapter_config.json`
    - `d:\code\edgex\config\shadow_core_config.json`
    - `d:\code\edgex\config\gossip_sync_config.json`